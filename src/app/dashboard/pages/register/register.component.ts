...
export default class RegisterComponent{
  ...
  // }
      registerAuth(): void {
        ...
        this.http.post<any>('https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyDSNgDmkvGv6a18hAk0CymT-_EgMORW50A', authData).subscribe(
          response => {
        ...
        this.http.post('https://happydogdb-55b97-default-rtdb.firebaseio.com/Users/'+this.uid.toString()+'.json?auth='+this.token.toString(),data).subscribe(
          response => {

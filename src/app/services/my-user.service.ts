...
export class MyUserService {
  ...
  public getMyInfo(uid:string, token:string):Observable<UsersModel>{
    return this.http.get<UsersModel>('https://happydogdb-55b97-default-rtdb.firebaseio.com/Users/'+uid+'.json?auth='+token);
  }
  ...
  public userUpdate(uid:string,token:string,userData:UsersModel):void{
    this.http.put('https://happydogdb-55b97-default-rtdb.firebaseio.com/Pets/'+uid+'.json?auth='+token,userData);
  }
